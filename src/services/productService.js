...
// Utility to normalize imageUrls from various formats
...
function normalizeImageUrls({ imageUrl, imageUrls }) {
  ...
  if (Array.isArray(imageUrls)) {
    ...
    // fallback if only single imageUrl
...
export const productService = {
  // List products + optional search & category
  ...
  async createProduct({
    ...
    // Normalize imageUrls from payload
  ...
  async updateProduct(id, payload) {
    ...
    // Update images (support array, JSON string, etc.)
