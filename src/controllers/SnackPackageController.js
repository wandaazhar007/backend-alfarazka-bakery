...
export const SnackPackageController = {
  async list(req, res, next) {
    try {
      ...
      // status: "all" | "active" | "inactive" (untuk ADMIN)
      const status = req.query.status;

      // onlyActive: untuk FRONTEND publik (halaman produk)
      // default: true kalau tidak dikirim sama sekali
      const onlyActiveParam = req.query.onlyActive;
      const onlyActive =
        onlyActiveParam === undefined
          ? true
          : !(
